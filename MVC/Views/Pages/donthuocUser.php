    ...
    <div class="main">
        ...
        <div class="container">
            <div class="container__header">
                <div class="search">
                    <form class="form_search" action="http://localhost/ManagerPatientPHP/donthuoc/timkiem"
                        method="POST">
                        <label for="" class="search__label">Tìm kiếm</label>
                        <input type="text" name="txtSearch" placeholder="Nhập tên thuốc"
                            value="<?php if(isset($data['id'])) echo $data['id'] ?>" id="txtSearch"
                            class="search__input">
                    ...
                    <div class="row__1">
                        <div class="name_medicine">
                            ...
                            <div class="name_medicine__input">
                                <input type="text" name="txtMaDonThuoc" id="txtNameMedicine" required
                                    placeholder="DT001">
                            </div>
                        </div>
                    ...
                    <div class="row__2">
                        ...
                        <div class="drug__content">
                            ...
                            <div class="drug__content__input">
                                <input type="date" max="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>"
                                    name="txtNgayKeDon" id="txtDrugContent" required>
                            </div>
                        </div>
                        <div class="supplier">
                            ...
                            <div class="supplier__input">
                                <select name="tenthuoc" class="namebenhnhan">
                                    <?php
                                        ...
                                        ?>
                                    <option value="<?php echo $row1['tenthuoc']?>"><?php echo $row1['tenthuoc']?>
                                    </option>
                                    <?php
                                                }
                                            }
                    ...
                    <div class="row__3">
                        <div class="route_of_use">
                            ...
                            <div class="route_of_use__input">
                                <input type="number" name="txtSoLuong" id="txtRouteOfUse" placeholder="300" min="0"
                                    required>
                            </div>
                        </div>
                        <div class="quantity">
