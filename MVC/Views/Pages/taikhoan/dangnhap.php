    ...
    <div class="auth">
        <div class="auth-container">
            <div class="container-left">
                ...
                <lord-icon src="https://cdn.lordicon.com/kibcffov.json" trigger="loop"
                    colors="outline:#121331,primary:#3a3347,secondary:#93150d,tertiary:#4bb3fd,quaternary:#ffc738,quinary:#ebe6ef,senary:#646e78"
                    style="width:350px;height:350px"></lord-icon>
            </div>
            <div class="container-right">
                <h1>Đăng nhập</h1>
                <h3>Chưa có tài khoản? <a href="http://localhost/ManagerPatientPHP/taikhoan/dangky">Đăng ký ngay</a>
                </h3>
                <form method="POST" action="http://localhost/ManagerPatientPHP/taikhoan/dangnhap">
                    <div class="mb-3">
                        <label for="email" class="form-label">Địa chỉ email</label>
                        <input name="email" required placeholder="Địa chỉ email" type="email" class="form-control"
                            id="email" aria-describedby="emailHelp">
                        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                    </div>
                    <div class="mb-3">
                        <label for="pasword" class="form-label">Mật khẩu</label>
                        <input name="password" required placeholder="Mật khẩu" type="password" class="form-control"
                            id="pasword">
                    </div>
