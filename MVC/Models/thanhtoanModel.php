...
class thanhtoanModel extends connectDB
{
    ...
    {
        $query = "SELECT * FROM `vienphi`, `benhnhan`, `baohiemyte`, `acount` ,thanhtoan WHERE thanhtoan.mavienphi=vienphi.mavienphi and acount.id = benhnhan.idtaikhoan and baohiemyte.idbaohiem=thanhtoan.idbaohiem and benhnhan.mabenhnhan='$mabenhnhan' and acount.username = baohiemyte.email";
        return mysqli_query($this->con, $query);
    }
